...
export default function Services() {
    return (
        <div id='services' className='bg-base-100'>
            <h1>Services</h1>
            <p>Jelajahi berbagai layanan yang saya tawarkan untuk memenuhi kebutuhan anda. Tujuan saya adalah memberikan solusi yang tidak hanya memenuhi ekpektasi namun juga melampauinya. Berikut beberapa layanan yang menjadi spesialis saya:</p>
