    ...
    <div className="navbar max-w-5xl mx-auto border-b sticky z-30">
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <Menu
            className={
              "menu-sm dropdown-content mt-10 z-[1] p-2 shadow bg-base-100 rounded-box w-32"
            }
          />
        </div>
        <a href="" className="text-xl font-extrabold text-slate-800">
          Arip Budiman
        </a>
      </div>
      ...
      <div className="navbar-end gap-x-4">
        <label className="swap swap-rotate">
          <input type="checkbox" />
          <svg
            className="swap-on fill-gray-600 w-10 h-10"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
          >
          ...
          <svg
            className="swap-off fill-gray-600 w-10 h-10"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
          >
